...
plot(rbind(knn_model(X_pre, X, Y, 1)$bias_ratio,knn_model(X_pre, X, Y, 3)$bias_ratio,knn_model(X_pre, X, Y, 10)$bias_ratio,knn_model(X_pre, X, Y, 20)$bias_ratio,knn_model(X_pre, X, Y, 50)$bias_ratio), type = "b", ylim = c(0,1), ylab = "", main = "Variance and Bias Ratio Behaviour")
lines(rbind(knn_model(X_pre, X, Y, 1)$var_ratio,knn_model(X_pre, X, Y, 3)$var_ratio,knn_model(X_pre, X, Y, 10)$var_ratio,knn_model(X_pre, X, Y, 20)$var_ratio,knn_model(X_pre, X, Y, 50)$var_ratio), lty = 4)
